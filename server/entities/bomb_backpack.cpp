...
{
public:void Spawn()override{PRECACHE_MODEL("models/w_satchel.mdl");SET_MODEL(edict(),"models/w_satchel.mdl");pev->solid=SOLID_NOT;pev->movetype=MOVETYPE_NOCLIP;SetThink(&CBombBackpack::FollowThink);pev->nextthink=gpGlobals->time;}
