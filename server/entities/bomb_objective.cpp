...
END_DATADESC()
void CObjectiveBomb::Precache() { PRECACHE_MODEL("models/w_satchel.mdl"); PRECACHE_SOUND("weapons/mine_deploy.wav"); PRECACHE_SOUND("buttons/blip1.wav"); }
void CObjectiveBomb::Spawn()
{
	Precache(); SET_MODEL(edict(), "models/w_satchel.mdl"); pev->solid = SOLID_BBOX; pev->movetype = MOVETYPE_TOSS; UTIL_SetSize(pev, Vector(-8,-8,0), Vector(8,8,8));
