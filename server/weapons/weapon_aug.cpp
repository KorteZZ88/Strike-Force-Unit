...
void CAUG::Precache()
{
	PRECACHE_MODEL("models/weapon/AUG/v_aug_mirror.mdl"); PRECACHE_MODEL("models/weapon/AUG/p_aug.mdl");
	PRECACHE_MODEL("models/weapon/AUG/w_aug.mdl"); PRECACHE_MODEL("models/shell.mdl");
	...
	PrecacheViewModelSounds("models/weapon/AUG/v_aug_mirror.mdl");
}
