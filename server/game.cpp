...
cvar_t	sk_plr_galil_bullet1 = { "sk_plr_galil_bullet1", "0" };
cvar_t	sk_plr_galil_bullet2 = { "sk_plr_galil_bullet2", "0" };
cvar_t	sk_plr_galil_bullet3 = { "sk_plr_galil_bullet3", "0" };
...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	CVAR_REGISTER(&sk_plr_galil_bullet1);
	CVAR_REGISTER(&sk_plr_galil_bullet2);
	CVAR_REGISTER(&sk_plr_galil_bullet3);
	CVAR_REGISTER(&sk_plr_famas_bullet1);
	CVAR_REGISTER(&sk_plr_famas_bullet2);
	CVAR_REGISTER(&sk_plr_famas_bullet3);
	CVAR_REGISTER(&sk_plr_sg552_bullet1);
	CVAR_REGISTER(&sk_plr_sg552_bullet2);
	CVAR_REGISTER(&sk_plr_sg552_bullet3);
	CVAR_REGISTER(&sk_plr_m60_bullet1);
	CVAR_REGISTER(&sk_plr_m60_bullet2);
	CVAR_REGISTER(&sk_plr_m60_bullet3);
