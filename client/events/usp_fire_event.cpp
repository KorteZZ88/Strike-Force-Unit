...
void CUSPFireEvent::Execute()
{
	...
	gEngfuncs.pEventAPI->EV_PlaySound(GetEntityIndex(), GetOrigin(), CHAN_WEAPON, silenced ? "weapons/USP/usp1.wav" : "weapons/USP/usp_unsil-1.wav", GetGunshotVolume(), silenced ? ATTN_NORM : GetGunshotAttenuation(), 0, PITCH_NORM);
}
