...
CAWPFireEvent::CAWPFireEvent(event_args_t* args) : CBaseGameEvent(args) {}
void DlightFlash(const Vector& origin, int index);
void CAWPFireEvent::Execute()
{
	...
	const char* sound=(m_arguments->iparam1 & 1)?"weapons/AWP/awp1.wav":"weapons/AWP/awp2.wav";
