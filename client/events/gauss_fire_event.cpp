...
void CGaussFireEvent::Execute()
{
	...
	gEngfuncs.pEventAPI->EV_PlaySound(GetEntityIndex(), GetOrigin(), CHAN_WEAPON, "weapons/gauss2.wav", GetGunshotVolume(), GetGunshotAttenuation(), 0, 85 + gEngfuncs.pfnRandomLong(0, 0x1f));
