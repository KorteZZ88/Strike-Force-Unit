...
CMP5A3FireEvent::CMP5A3FireEvent(event_args_t *args) :
	CBaseGameEvent(args)
{
}
...
void CMP5A3FireEvent::Execute()
{
	HandleShot();
}

void CMP5A3FireEvent::HandleShot()
{
...
Vector CMP5A3FireEvent::GetShootDirection(const matrix3x3 &camera) const
{
